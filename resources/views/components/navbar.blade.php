        ...
        <div class="flex items-center justify-between max-w-screen-xl px-4 py-1 mx-auto text-xs">
          ...
          <nav itemscope itemtype="http://schema.org/SiteNavigationElement" aria-label="Primary">
            <div itemprop="about" itemscope itemtype="http://schema.org/ItemList"
              ...
              <a itemprop="itemListElement" href="{{ route('site.discounts') }}" class="px-3 py-2 hover:underline">
                Акции и подарки
              </a>
            ...
            @auth
              <a title="Избранное" href="{{ route('account.favorites') }}"
                ...
                <svg class="w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path
                    class="text-orange-400 stroke-current group-hover:bg-orange-400 group-hover:fill-current focus:bg-orange-400"
