...
class Category extends Component
{
    ...
    public function mount()
    {
        ...
        if (!empty($this->tag)) {
            $this->getTagFilters();
            $this->metaTitle = '👍 ' . $this->tag->meta_title . ', купите в новом интернет зоомагазине спб с доставкой (цена от ' . $this->minPrice . ' рублей), акции и скидки, петшопы в Невском районе и пр. Просвещения';
            $this->name = $this->tag->name;
            $this->metaDescription = '👍 ' . $this->tag->meta_title . ' (в наличии) купите в спб 🚚 с бесплатной доставкой в интернет зоомагазине (цена от ' . $this->minPrice . ' рублей) ❗ фото, составы, описание, применение, дозировка, акции и скидки 🧡 душевное обслуживание, гарантии, самовывоз из Невского района и с пр. Просвещения';
        } else {
