<div x-data="{ open: false }" class="relative max-w-xs">
  <button @click="open = !open" @click.outside="open = false"
    class="flex items-center w-auto py-1 pl-2 pr-1 text-xs text-left text-gray-700 border border-gray-200 rounded-lg bg-gray-50 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:border-blue-400 focus:outline-none">
    <span>{{ $title }}</span>
