<footer class="text-white bg-gray-100">
  ...
  <div class="max-w-screen-xl px-24 py-24 mx-auto md:px-4">
    <div
      ...
      <div class="">
        <h2 class="mb-4 text-sm font-medium tracking-widest text-gray-600 uppercase title-font">пн-пт 8:00 - 20:00</h2>
        ...
        <span class="inline-flex space-x-4 justify-right">
          ...
          <a target="_blank" href="https://vk.com/zoopodarki" class="ml-3 text-gray-500" title="vk">
