...
<div>
  ...
  <div>
    <div class="items-center justify-between block w-full pb-4 lg:flex lg:space-x-8">
      ...
      <div class="items-center justify-start block space-y-4 lg:space-y-0 lg:space-x-6 lg:flex lg:w-2/3">
        ...
        <div wire:ignore class="flex items-center justify-end py-3">
          <div class="max-w-xs">
            ...
            <select wire:model="filteredByCategory" name="filteredByCategory" id="filteredByCategory" class="w-64">
    ...
    <div class="items-center justify-start block pb-2 space-y-4 lg:space-y-0 lg:space-x-8 lg:flex">

      <x-toggle wire:model="filteredByAttribute" :property="$filteredByAttribute" :lable="'Искать по свойству'" />

      <x-toggle wire:model="productsWithoutDescription" :property="$productsWithoutDescription"
        :lable="'Без описания'" />
          ...
          <x-dashboard.table.row wire:key="{{ $loop->index }}">
            ...
            <x-dashboard.table.cell>
              <div class="flex items-center justify-end space-x-4">
                ...
                @if($onlyTrashed)
                <button title="Востановить" wire:click.debounce.500ms="restoreTrashed({{ $product->id }})" class="p-2">
