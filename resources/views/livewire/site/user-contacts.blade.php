        ...
        <div class="space-y-4">
          ...
          <div x-cloak x-data="{ newContact: false }" x-on:close-form.window="newContact = false"
            ...
            <div x-show="newContact === false" x-transition.opacity>
                ...
                <div wire:key="{{ $loop->index }}"
                  ...
                  <div>
                    ...
                    <div x-cloak x-data="{ open: false }" class="absolute top-0 right-0 z-40 p-2 rounded-r-xl"
                      ...
                      <div x-show="open === false" x-transition.opacity class="cursor-pointer" x-on:click="open = true"
              ...
              @if (empty($contacts) || $contacts->count() <= 4 ) <div x-on:click="newContact = true"
          ...
          <div x-show="newContact" x-transition.opacity>
            ...
            <div class="block w-full space-y-4">
              <div class="w-full">
                ...
                <input wire:model.defer="newContact.name" name="name" class="field" type="text" autocomplete="name">
              ...
              <div class="w-full">
                ...
                <input wire:model.defer="newContact.phone" name="phone" class="field" type="phone" autocomplete="phone"
                  inputmode="tel">
              ...
              <div class="w-full">
                ...
                <input wire:model.defer="newContact.email" name="email" class="field" type="email" autocomplete="email"
                  inputmode="email">
